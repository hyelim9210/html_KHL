...
<!--============= 검색 조건 추가하기   끝   ===============-->
	...
	<!--====================== 우편번호 찾기  끝   =======================-->
	<!--====================== 사원등록 시작 =======================-->
	<div id="dlg_ins" data-options="closed:true, title:'사원정보 등록', modal:'true'" class="easyui-dialog" style="width:100%;max-width:600px;padding:30px 60px">
		<form id="f_ins">
			...
			<div style="margin-bottom:10px">
			<input class="easyui-combobox" id="deptno" name="deptno" label="부서번호"  data-options="prompt:'Enter a 부서번호'" style="width:250px">
			</div>			
			<div style="margin-bottom:10px">
