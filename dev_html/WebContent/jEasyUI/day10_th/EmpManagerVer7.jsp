...
<%@ include file="./JEasyUICommon.jsp" %>
	<script type="text/javascript">
		...
		function emp_ins(){
			//화면에서 입력받은 값은 http 프로토콜을 이용해서 서버 쪽으로 전송 되는데, 이 때 유니코드로 변환되어 전달된다.
			//해결방법 : server.xml 문서에 포트번호 설정하는 위치(63번)에 URIEncoding = "UTF-8" 을 추가해준다.
			//단, 이 방법은 get 방식일 때만 적용되고 post 방식일 때는 java 코드를 활용하여 별도 처리를 해야한다. 나중에 배우자.
			alert("등록 처리");
			$("#f_ins").attr("method", "get");
			$("#f_ins").attr("action", "insertAction.jsp");
			$("#f_ins").submit();
...
<!--============= 검색 조건 추가하기   끝   ===============-->
	...
	<!--====================== 우편번호 찾기  끝   =======================-->
	<!--====================== 사원등록 시작 =======================-->
	<div id="dlg_ins" data-options="closed:true, title:'사원정보 등록', footer:'#buttons', modal:'true'" class="easyui-dialog" style="width:100%;max-width:600px;padding:30px 60px">
		<form id="f_ins">
